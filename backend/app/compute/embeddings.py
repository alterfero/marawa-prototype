...
class SentenceTransformerBackend:
    ...
    def _load_model(self):
        if self._model is None:
            ...
            # Embeddings are generated by one in-process model.  Do not let
            # Transformers select its memory-saving device-map path: it can
            # leave parameters on the meta device, which SentenceTransformer
            # later cannot move with ``Module.to``.
